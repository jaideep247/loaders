sap.ui.define([
     ...
     */
    return BaseObject.extend("assetretirementwr.utils.DataTransformer", {
        /**
        ...
        processRowsForExport: function (rows, reportType) {
            ...
            return filteredRows.map(row => {
                return {
                    ...
                    "Fixed Asset Retirement Revenue Type": row.FxdAstRetirementRevenueType || "",
                    "Asset Revenue Amount In Transaction Currency": row.AstRevenueAmountInTransCrcy || "",
                    "Fixed Asset Retirement Revenue Transaction Currency": row.FxdAstRtrmtRevnTransCrcy || "",
                    "Fixed Asset Retirement Revenue Currency Role": row.FxdAstRtrmtRevnCurrencyRole || "",
        ...
        processResultsForExport: function (batchData, type) {
            ...
            return recordsToProcess.map(record => {
                ...
                return {
                    ...
                    "Fixed Asset Retirement Revenue Type": entry.FxdAstRetirementRevenueType || "",
                    "Asset Revenue Amount In Transaction Currency": entry.AstRevenueAmountInTransCrcy || "",
                    "Fixed Asset Retirement Revenue Transaction Currency": entry.FxdAstRtrmtRevnTransCrcy || "",
                    "Fixed Asset Retirement Revenue Currency Role": entry.FxdAstRtrmtRevnCurrencyRole || "",
                    ...
                    "Response Document Number": message.details?.documentNumber ||
                        message.details?.extractedDetails?.documentNo ||
        ...
        transformFixedAssetRetirementToOData: function (entry) {
            ...
            return {
                ...
                // Revenue Information
                FxdAstRetirementRevenueType: entry.FxdAstRetirementRevenueType,
                AstRevenueAmountInTransCrcy: this._formatAmount(entry.AstRevenueAmountInTransCrcy),
                FxdAstRtrmtRevnTransCrcy: entry.FxdAstRtrmtRevnTransCrcy || "",
                FxdAstRtrmtRevnCurrencyRole: entry.FxdAstRtrmtRevnCurrencyRole,
                ...
                // Additional fields specific to the retirement transaction
                AstRtrmtAmtInTransCrcy: this._formatAmount(entry.AstRtrmtAmtInTransCrcy),
                FxdAstRetirementTransCrcy: entry.FxdAstRetirementTransCrcy || entry.FxdAstRtrmtRevnTransCrcy || "",
            };
        },
