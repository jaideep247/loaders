sap.ui.define([
    "assetretirementwor/utils/XlsxFormatter" // Adjust path if needed
    ...
    return class TemplateGenerator {
                ...
                try {
                    ...
                    if (useDefault) {
                        ...
                        const headers = [
                            ...
                            "Fixed Asset Retirement Type", "Document Reference ID", "Accounting Document Header Text",
                            "Base Unit SAP Code", "Base Unit ISO Code", "Accounting Document Type",
                            "Assignment Reference", "Document Item Text"
                        ];
                        ...
                        const exampleRow = {
                            ...
                            "Business Transaction Type": "RA21",
                            "Company Code": "1000",
                            "Master Fixed Asset": "20003491",
                            "Fixed Asset": "0",
        ...
        _getHelpSheetData() {
            if (!this._validationManager || typeof this._validationManager.getFieldConstraintsDescription !== 'function') {
                ...
                // Return basic help data for Asset Retirement template
                return [
                    ...
                    { "Field Name (Excel Header)": "Business Transaction Type", "Technical Field Name": "BusinessTransactionType", "Description & Constraints": "Transaction type code (e.g., RA21) (Required)" },
