    ...
    return function (oController, oErrorHandlerInstance) {
      ...
      this.handleValidationErrors = function (errors) {
        ...
        this._loadAndShowDialog(
          ...
          "grn.view.ValidationErrorsDialog", // <<< ADJUST NAMESPACE
          oValidationModel,
      ...
      this.showEntryDetailsDialog = function (oEntry) {
        ...
        const fragmentName = "grn.view.EntryDetailsDialog"; // <<< ADJUST NAMESPACE
      ...
      this.showErrorSummaryDialog = function (errors, exportManager) {
        ...
        const dialogId = "errorSummaryDialog"; const fragmentName = "grn.view.ErrorSummaryDialog"; // <<< ADJUST NAMESPACE
      ...
      this.showValidationStatsDialog = function (total = 0, successful = 0, failed = 0) {
        ...
        const dialogId = "validationStatsDialog"; const fragmentName = "grn.view.ValidationStatsDialog"; // <<< ADJUST NAMESPACE
        // Destroy this dialog on close
      ...
      this.showHelpDialog = function (controllerContext) {
        ...
        const dialogId = "helpDialog"; const fragmentName = "grn.view.HelpDialog"; // <<< ADJUST NAMESPACE
      ...
      this.showSuccessWithDocuments = function (successEntries) {
        const dialogId = "successDialog"; const fragmentName = "grn.view.SuccessDialog"; // <<< ADJUST NAMESPACE
      ...
      this.showPartialSuccessWithDocuments = function (successEntries, failedEntries) {
        const dialogId = "partialSuccessDialog"; const fragmentName = "grn.view.PartialSuccessDialog"; // <<< ADJUST NAMESPACE
      ...
      this.showErrorWithDetails = function (failedEntries) {
        const dialogId = "errorDialog"; const fragmentName = "grn.view.ErrorDialog"; // <<< ADJUST NAMESPACE
      ...
      this.initBatchProcessingDisplay = function (container) { /* ... */
        ...
        return new Promise((resolve, reject) => {
          ...
          const fragmentName = "grn.view.BatchProcessingDisplay"; const fragmentId = this.oController.getView().createId("batchProcessingDisplayFragment");
