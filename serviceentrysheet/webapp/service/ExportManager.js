sap.ui.define([
  ...
  return class ExportManager {
    ...
    constructor(options = {}) {
      ...
      this._fieldMappings = {
        // Service Entry Sheet Specific Mappings
        'SL': 'SequenceNumber',
        'ServiceEntrySheetNumber': 'ServiceEntrySheetNumber',
        'Service EntrySheet Number': 'ServiceEntrySheetNumber',
        'GRNNumber': 'GRNNumber',
        ...
        'Service Entry Sheet Name': 'ServiceEntrySheetName',
        'Supplier': 'Supplier',
        'PostingDate': 'PostingDate',
        'Posting Date': 'PostingDate',
        'ServiceEntrySheetItem': 'ServiceEntrySheetItem',
        'Service Entry Sheet Item': 'ServiceEntrySheetItem',
        ...
        'Service Performance Date': 'ServicePerformanceDate',
        'ServicePerformanceEndDate': 'ServicePerformanceEndDate',
        'Service Performance End Date': 'ServicePerformanceEndDate',
        ...
        'GRN Creation': 'GRNCreate', // Mapping for the GRN indicator
