sap.ui.define([
  ...
  return function (oController) {
    ...
    this._createBatchProcessingDisplay = function (container, useAddItem) {
      ...
      try {
        if (sap.ui.require.toUrl("vendor_to_vendor/control/BatchProcessingDisplay")) {
          const BatchProcessingDisplayClass = sap.ui.require("vendor_to_vendor/control/BatchProcessingDisplay");
      ...
      try {
        sap.ui.require(["vendor_to_vendor/control/BatchProcessingDisplay"], (BatchProcessingDisplay) => {
    ...
    this._extractTransactionIdFromSoapResponse = function (responseText) {
