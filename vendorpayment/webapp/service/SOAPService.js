sap.ui.define([
  ...
  return BaseObject.extend("vendorpayment.service.SOAPService", {
      ...
      journalEntries.forEach((entry, index) => {
        ...
        if (entry.glTransactions && Array.isArray(entry.glTransactions)) {
          entry.glTransactions.forEach((item) => {
            // Find the corresponding debtor transaction to get the Vendor code
            ...
            soapEnvelope += `<Item>
                                ...
                                <AccountAssignment>
                                    <CostCenter>${item["Profit Center"] || ""}</CostCenter>
                                </AccountAssignment>                              
