sap.ui.define([
  ...
  "vendorpayment/service/SOAPService",
  ...
  return function (oController) {
    ...
    this._createBatchProcessingDisplay = function (container, useAddItem) {
      ...
      try {
        if (sap.ui.require.toUrl("vendorpayment/control/BatchProcessingDisplay")) {
          const BatchProcessingDisplayClass = sap.ui.require("vendorpayment/control/BatchProcessingDisplay");
      ...
      try {
        sap.ui.require(["vendorpayment/control/BatchProcessingDisplay"], (BatchProcessingDisplay) => {
