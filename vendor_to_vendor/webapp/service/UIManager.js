sap.ui.define([
  ...
  return function (oController) {
    ...
    this.showEntryDetailsDialog = function (oEntry) {
      ...
      // Determine entry type - Vendor Debit or Vendor Credit
      const isVendorDebit = oEntry["Sheet"] === "Vendor Debit Lines";
      ...
      // Process line fields
      vendorLineFields.forEach(fieldName => {
      ...
      const dialogTitle = isVendorDebit ? "Vendor Debit Line Entry Details" : "Vendor Credit Line Entry Details";
      const lineHeaderText = isVendorDebit ? "Vendor Debit Line Information" : "Vendor Credit Line Information";
              ...
              new sap.m.ObjectHeader({
                ...
                statuses: [
                  new sap.m.ObjectStatus({
                    text: isVendorDebit ? "Debit" : "Credit",
                    state: isVendorDebit
    ...
    this.showHelpDialog = function () {
      ...
      if (!this._dialogs.helpDialog) {
        Fragment.load({
          name: "vendortovendor.view.HelpDialog",
          controller: this.oController
        }).then((oDialog) => {
          // Store the dialog for future use
    ...
    this.showSuccessWithDocuments = function (successEntries) {
      ...
      if (!this._dialogs.successDialog) {
        Fragment.load({
          name: "vendortovendor.view.SuccessDialog",
          controller: this.oController
    ...
    this.showPartialSuccessWithDocuments = function (successEntries, failedEntries, successCount, failedCount) {
      ...
      if (!this._dialogs.partialSuccessDialog) {
        Fragment.load({
          name: "vendortovendor.view.PartialSuccessDialog",
          controller: this.oController
        }).then(function (oDialog) {
    ...
    this.initBatchProcessingDisplay = function (container) {
      ...
      return new Promise((resolve, reject) => {
        ...
        Fragment.load({
          name: "vendortovendor.view.BatchProcessingDisplay",
          controller: this.oController
        }).then(oFragment => {
