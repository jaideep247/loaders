sap.ui.define([
    ...
    return BaseObject.extend("customercollection.model.ModelManager", {
      /**
      ...
      _initJournalEntriesModel: function() {
        const oJournalEntriesModel = new JSONModel({
          transactions: [],
          validationStatus: "Pending",
          filteredCount: 0
        });
        this._view.setModel(oJournalEntriesModel, "journalEntries");
      },
