  ...
  return function (oController) {
    ...
    this.processExcelFile = function (file) {
      ...
      reader.onload = (e) => {
        try {
          ...
          const requiredSheets = ["Header", "Bank Lines", "Customer Lines"];
          ...
          if (!validationResult.isValid) {
            ...
            const enhancedErrors = validationResult.errors.map(error => {
              ...
              if (error.sheet) {
                ...
                else if (error.includes("Credit")) errorObj.sheet = "Customer Lines";
              }
    ...
    this._parseMultiSheetWorkbook = function (workbook) {
      try {
        ...
        const customerSheet = options.creditSheet || "Customer Lines";
        ...
        if (!workbook.Sheets[customerSheet]) {
          throw new Error(`Customer line sheet"${customerSheet}" not found in workbook`);
        }
        ...
        const creditSheet = workbook.Sheets[customerSheet];
          ...
          const mappedDebitEntries = debitData
            ...
            .map((debitEntry) => {
              const [
                ...
                referenceKey1, itemText, houseBank,
                accountId, profitCenter, businessPlace, valueDate,
              ] = debitEntry;
        ...
        // Convert transaction groups to a flat array
